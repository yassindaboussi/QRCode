...
public class QRCodeEngine {
    ...
    public static String decode(Image image) throws ReaderException {
...
//            errorAlert.setHeaderText("QrCode Not found");
//            errorAlert.setContentText("This Picture doesn't contain Any QRCODE");
